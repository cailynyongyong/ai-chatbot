...
export function UploadDocumentsForm() {
  ...
  return (
    <form onSubmit={ingest} className="flex mb-4 space-x-2">
      <Input value={document} onChange={(e) => setDocument(e.target.value)} />
      <Button type="submit" className="text-white bg-black  hover:bg-gray-700">
        <div
          role="status"
    ...
    // <form
    //   onSubmit={ingest}
    //   className="flex items-center justify-center w-full mb-4 space-x-4"
    // >
    //   <Input
    ...
    //   <Button
    //     type="submit"
    //     className="px-8 py-4 bg-black rounded shrink-0 w-28"
    //   >
    //     <div
    //       role="status"
    //       className={`${isLoading ? "" : "hidden"} flex justify-center`}
